...
class FCITextStyle {
  ...
  String getFontFamily() {
    ...
    return GoogleFonts.salsa().fontFamily;
  }
...
class FCIColors {
  ...
  ///-----------------------------
  static Color primaryColor() => Color(0xFFfbe4b2);
  static Color primarySwatch() => Colors.amber;
  static Color primaryColorDark() => Color(0xFFC7B285);
  static Color primaryColorLight() => Color(0xFFFCF3E1);
  static Color accentColor() => Color(0xFFA3A3A3);
  static Color hintColor() => Color(0xff8D8D8D);
  static Color dividerColor() => Color(0xff252B2E);
