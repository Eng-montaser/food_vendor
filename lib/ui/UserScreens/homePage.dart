...
import 'package:food_vendor/ui/UserScreens/earningPage.dart';
import 'package:food_vendor/utils/constants.dart';
import 'package:food_vendor/widgets/ordercard.dart';
...
class _HomeScreenPage extends State<HomePage> {
  @override
  void initState() {
    super.initState();
  }
